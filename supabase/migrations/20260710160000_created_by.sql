...
-- 1. Coluna created_by (preenchida automaticamente no insert)
...
-- 2. Somente admins podem alterar created_by (guard no banco)
...
-- 3. Auto-vínculo: criador entra como editor do projeto
--    (o guard de domínio @berry.com.br em project_members continua valendo;
--     por isso o vínculo só é criado para usuários Berry)
